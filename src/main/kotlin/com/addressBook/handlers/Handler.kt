...
//    Handler functions for GROUP MEMBERS
    ...
    fun connectGroupWithContactsHandler(cmd: ConnectGroupwtihContactsCommand): Either<Exception, String> {
        return cmd.execute()
    }
    ...
    fun displayGroupMembersByGroupIdHandler(cmd: DisplayGroupMembersByGroupIdCommand): Either<Exception, List<Contact>> {
        return cmd.execute()
    }
}